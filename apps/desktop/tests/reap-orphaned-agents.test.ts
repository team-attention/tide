...
const processList = [
  ...
  "42001     1 /Users/me/.local/bin/agy --prompt-interactive hi TIDE_RUNTIME_ID=runtime-abc TIDE_THREAD_ID=id-1",
  // Orphaned (ppid 1) python PTY bridge carrying the tag. Reap it.
  "42002     1 python3 -c <bridge> agy TIDE_RUNTIME_ID=runtime-xyz",
