...
//
// This module is the pure host-window decision. main-window wires it onto the
// Tide React app's own webContents; BrowserRuntime WebContentsView instances
// own browser navigation/popup behavior inside BrowserRuntimeHost.
