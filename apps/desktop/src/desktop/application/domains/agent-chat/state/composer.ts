...
import { initialOpencodeModelProviderFlowState } from "./opencode-model-provider.ts";
  ...
  return {
    state: {
      ...
      composer: {
        ...
        ...(normalizedSurface === "opencode_model_provider"
          ? { opencodeModelProvider: initialOpencodeModelProviderFlowState() }
          : {}),
      },
    },
    command: null,
