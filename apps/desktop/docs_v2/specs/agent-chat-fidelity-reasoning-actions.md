...
- Files: `shared/contracts/agent-session-block.ts`,
  ...
  `backend/infrastructure/node/provider/provider-history-helpers.ts`,
  `backend/infrastructure/node/live/live-backend-json.ts`,
  `backend/infrastructure/node/provider/provider-history-readers.ts`,
  `backend/infrastructure/node/provider/provider-conversation-rebuilders.ts`,
