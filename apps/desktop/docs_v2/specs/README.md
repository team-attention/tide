...
| [Agent Runtime Process Ownership](agent-runtime-process-ownership.md) | Drafted | Main-based plan to make App -> Backend -> provider runtime -> MCP bridge ownership explicit across Codex, Claude, opencode, and future provider agents. |
