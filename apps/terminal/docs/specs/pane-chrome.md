...
13. Keep the macOS titlebar at 32 logical pixels while Pane headers, shared tab bars, and the FileTree View header use one exact 28 logical-pixel height; keep header typography and icon layout fixed when content font zoom changes.
...
- **Flow**:
  1. Tide keeps the macOS titlebar at 32 logical pixels and applies the shared 28 logical-pixel height to Pane headers, shared tab bars, and the FileTree View header
  2. Tide uses fixed chrome metrics for header typography and icons, independent of content font zoom, and vertically centers them within each band
...
- **Business Rules**:
  - BR-19: The macOS titlebar is exactly 32 logical pixels high; Pane headers, shared tab bars, and the FileTree View header are exactly 28 logical pixels high; header typography and icon layout remain fixed when content font zoom changes
...
6. The macOS titlebar remains exactly 32 logical pixels high, while Pane headers, shared tab bars, and the FileTree View header share an exact 28 logical-pixel height and fixed chrome metrics.
