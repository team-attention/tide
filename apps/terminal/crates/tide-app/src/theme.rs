// UI theme constants — named palettes with dark/light modes.
...
// ──────────────────────────────────────────────
// GRAPHITE palette — neutral, steel-accented, low glare
// ──────────────────────────────────────────────

pub static GRAPHITE_DARK: ThemePalette = ThemePalette {
    surface_bg: Color::new(0.030, 0.032, 0.036, 1.0),
    pane_bg: Color::new(0.062, 0.066, 0.073, 1.0),
    file_tree_bg: Color::new(0.044, 0.047, 0.052, 1.0),
    border_color: Color::new(0.035, 0.037, 0.041, 1.0),
    border_focused: Color::new(0.455, 0.584, 0.675, 0.72),
    border_subtle: Color::new(0.140, 0.150, 0.164, 1.0),
    tree_text: Color::new(0.560, 0.575, 0.596, 1.0),
    tree_dir: Color::new(0.700, 0.710, 0.724, 1.0),
    tree_dir_icon: Color::new(0.610, 0.690, 0.740, 1.0),
    tree_icon: Color::new(0.310, 0.330, 0.360, 1.0),
    tree_row_active: Color::new(0.455, 0.584, 0.675, 0.075),
    file_tree_focus_fill: Color::new(0.455, 0.584, 0.675, 0.120),
    file_tree_focus_stroke: Color::new(0.455, 0.584, 0.675, 0.240),
    tab_bar_bg: Color::new(0.075, 0.079, 0.087, 1.0),
    tab_bar_bg_focused: Color::new(0.103, 0.113, 0.126, 1.0),
    active_tab_bg: Color::new(0.057, 0.061, 0.068, 1.0),
    tab_text: Color::new(0.390, 0.410, 0.440, 1.0),
    tab_text_active: Color::new(0.690, 0.708, 0.724, 1.0),
    tab_text_focused: Color::new(0.928, 0.938, 0.944, 1.0),
    close_icon: Color::new(0.410, 0.430, 0.460, 1.0),
    dock_tab_underline: Color::new(0.455, 0.584, 0.675, 1.0),
    gutter_text: Color::new(0.390, 0.430, 0.460, 1.0),
    gutter_active_text: Color::new(0.790, 0.825, 0.845, 1.0),
    editor_modified: Color::new(0.735, 0.610, 0.360, 1.0),
    panel_tab_bg_active: Color::new(0.050, 0.054, 0.060, 1.0),
    drop_fill: Color::new(0.455, 0.584, 0.675, 0.090),
    drop_border: Color::new(0.455, 0.584, 0.675, 0.300),
    swap_border: Color::new(0.455, 0.584, 0.675, 0.420),
    hover_tab: Color::new(0.455, 0.584, 0.675, 0.070),
    search_match_bg: Color::new(0.735, 0.610, 0.360, 0.38),
    search_current_bg: Color::new(0.735, 0.610, 0.360, 0.58),
    search_bar_bg: Color::new(0.060, 0.064, 0.071, 1.0),
    search_bar_border: Color::new(0.455, 0.584, 0.675, 0.22),
    search_bar_text: Color::new(0.885, 0.895, 0.902, 1.0),
    selection: Color::new(0.455, 0.584, 0.675, 0.34),
    cursor_accent: Color::new(0.850, 0.900, 0.925, 1.0),
    badge_bg: Color::new(0.455, 0.584, 0.675, 0.145),
    badge_bg_unfocused: Color::new(0.455, 0.584, 0.675, 0.090),
    badge_text: Color::new(0.700, 0.740, 0.765, 1.0),
    badge_text_dimmed: Color::new(0.410, 0.430, 0.460, 1.0),
    badge_git_branch: Color::new(0.690, 0.760, 0.800, 1.0),
    badge_git_worktree: Color::new(0.440, 0.720, 0.690, 1.0),
    popup_bg: Color::new(0.058, 0.062, 0.069, 1.0),
    popup_border: Color::new(0.150, 0.165, 0.184, 1.0),
    popup_selected: Color::new(0.455, 0.584, 0.675, 0.090),
    link_color: Color::new(0.500, 0.660, 0.780, 1.0),
    current_line_bg: Color::new(0.455, 0.584, 0.675, 0.045),
    indent_guide: Color::new(0.455, 0.584, 0.675, 0.080),
    active_indent_guide: Color::new(0.455, 0.584, 0.675, 0.155),
    bracket_match_bg: Color::new(0.455, 0.584, 0.675, 0.105),
    bracket_match_border: Color::new(0.455, 0.584, 0.675, 0.300),
    scrollbar_thumb_hover: Color::new(0.455, 0.584, 0.675, 0.280),
    ws_sidebar_text_inactive: Color::new(0.620, 0.640, 0.665, 1.0),
    ..DARK
};

pub static GRAPHITE_LIGHT: ThemePalette = ThemePalette {
    surface_bg: Color::rgb(0.944, 0.947, 0.950),
    pane_bg: Color::rgb(0.982, 0.984, 0.986),
    file_tree_bg: Color::rgb(0.936, 0.940, 0.944),
    border_color: Color::rgb(0.775, 0.790, 0.805),
    border_focused: Color::new(0.370, 0.500, 0.600, 0.44),
    border_subtle: Color::rgb(0.775, 0.790, 0.805),
    tree_text: Color::rgb(0.185, 0.200, 0.220),
    tree_dir: Color::rgb(0.145, 0.160, 0.180),
    tree_dir_icon: Color::rgb(0.350, 0.500, 0.610),
    tree_icon: Color::rgb(0.440, 0.460, 0.485),
    tree_row_active: Color::new(0.370, 0.500, 0.600, 0.085),
    file_tree_focus_fill: Color::new(0.370, 0.500, 0.600, 0.120),
    file_tree_focus_stroke: Color::new(0.370, 0.500, 0.600, 0.280),
    tab_bar_bg: Color::rgb(0.936, 0.940, 0.944),
    tab_bar_bg_focused: Color::rgb(0.955, 0.958, 0.962),
    active_tab_bg: Color::rgb(0.982, 0.984, 0.986),
    tab_text: Color::rgb(0.435, 0.455, 0.480),
    tab_text_active: Color::rgb(0.260, 0.285, 0.310),
    tab_text_focused: Color::rgb(0.140, 0.155, 0.175),
    close_icon: Color::rgb(0.435, 0.455, 0.480),
    dock_tab_underline: Color::rgb(0.370, 0.500, 0.600),
    gutter_text: Color::rgb(0.370, 0.500, 0.600),
    gutter_active_text: Color::rgb(0.140, 0.155, 0.175),
    editor_modified: Color::rgb(0.620, 0.500, 0.290),
    drop_fill: Color::new(0.370, 0.500, 0.600, 0.095),
    drop_border: Color::new(0.370, 0.500, 0.600, 0.280),
    swap_border: Color::new(0.370, 0.500, 0.600, 0.380),
    scrollbar_match: Color::new(0.620, 0.500, 0.290, 0.42),
    scrollbar_current: Color::rgb(0.370, 0.500, 0.600),
    hover_tab: Color::rgb(0.895, 0.905, 0.915),
    search_match_bg: Color::new(0.620, 0.500, 0.290, 0.48),
    search_current_bg: Color::new(0.620, 0.500, 0.290, 0.74),
    search_bar_bg: Color::rgb(0.982, 0.984, 0.986),
    search_bar_border: Color::rgb(0.775, 0.790, 0.805),
    search_bar_text: Color::rgb(0.140, 0.155, 0.175),
    selection: Color::new(0.370, 0.500, 0.600, 0.25),
    cursor_accent: Color::rgb(0.140, 0.155, 0.175),
    badge_bg: Color::new(0.370, 0.500, 0.600, 0.095),
    badge_bg_unfocused: Color::new(0.370, 0.500, 0.600, 0.060),
    badge_text: Color::rgb(0.170, 0.210, 0.250),
    badge_text_dimmed: Color::rgb(0.435, 0.455, 0.480),
    badge_git_branch: Color::rgb(0.370, 0.500, 0.600),
    badge_git_worktree: Color::rgb(0.300, 0.560, 0.560),
    popup_bg: Color::rgb(0.982, 0.984, 0.986),
    popup_border: Color::rgb(0.775, 0.790, 0.805),
    popup_selected: Color::new(0.370, 0.500, 0.600, 0.095),
    popup_scrim: Color::new(0.0, 0.0, 0.0, 0.14),
    link_color: Color::rgb(0.370, 0.500, 0.600),
    current_line_bg: Color::rgb(0.925, 0.932, 0.938),
    indent_guide: Color::rgb(0.765, 0.780, 0.795),
    active_indent_guide: Color::rgb(0.500, 0.530, 0.560),
    bracket_match_bg: Color::new(0.370, 0.500, 0.600, 0.18),
    bracket_match_border: Color::rgb(0.370, 0.500, 0.600),
    ws_sidebar_text_inactive: Color::rgb(0.435, 0.455, 0.480),
    ..LIGHT
};

// ──────────────────────────────────────────────
// SAGE palette — green-biased neutrals with restrained botanical accents
// ──────────────────────────────────────────────

pub static SAGE_DARK: ThemePalette = ThemePalette {
    surface_bg: Color::new(0.032, 0.037, 0.034, 1.0),
    pane_bg: Color::new(0.064, 0.072, 0.067, 1.0),
    file_tree_bg: Color::new(0.046, 0.052, 0.048, 1.0),
    border_color: Color::new(0.037, 0.042, 0.039, 1.0),
    border_focused: Color::new(0.520, 0.640, 0.545, 0.72),
    border_subtle: Color::new(0.138, 0.160, 0.146, 1.0),
    tree_text: Color::new(0.555, 0.585, 0.560, 1.0),
    tree_dir: Color::new(0.690, 0.720, 0.690, 1.0),
    tree_dir_icon: Color::new(0.590, 0.700, 0.590, 1.0),
    tree_icon: Color::new(0.300, 0.335, 0.305, 1.0),
    tree_row_active: Color::new(0.520, 0.640, 0.545, 0.075),
    file_tree_focus_fill: Color::new(0.520, 0.640, 0.545, 0.120),
    file_tree_focus_stroke: Color::new(0.520, 0.640, 0.545, 0.240),
    tab_bar_bg: Color::new(0.076, 0.084, 0.079, 1.0),
    tab_bar_bg_focused: Color::new(0.104, 0.124, 0.110, 1.0),
    active_tab_bg: Color::new(0.058, 0.066, 0.061, 1.0),
    tab_text: Color::new(0.385, 0.420, 0.390, 1.0),
    tab_text_active: Color::new(0.680, 0.705, 0.670, 1.0),
    tab_text_focused: Color::new(0.925, 0.938, 0.920, 1.0),
    close_icon: Color::new(0.400, 0.430, 0.405, 1.0),
    dock_tab_underline: Color::new(0.520, 0.640, 0.545, 1.0),
    gutter_text: Color::new(0.405, 0.470, 0.410, 1.0),
    gutter_active_text: Color::new(0.790, 0.835, 0.780, 1.0),
    editor_modified: Color::new(0.720, 0.610, 0.350, 1.0),
    panel_tab_bg_active: Color::new(0.050, 0.057, 0.053, 1.0),
    drop_fill: Color::new(0.520, 0.640, 0.545, 0.090),
    drop_border: Color::new(0.520, 0.640, 0.545, 0.300),
    swap_border: Color::new(0.520, 0.640, 0.545, 0.420),
    hover_tab: Color::new(0.520, 0.640, 0.545, 0.070),
    search_match_bg: Color::new(0.720, 0.610, 0.350, 0.38),
    search_current_bg: Color::new(0.720, 0.610, 0.350, 0.58),
    search_bar_bg: Color::new(0.060, 0.068, 0.063, 1.0),
    search_bar_border: Color::new(0.520, 0.640, 0.545, 0.22),
    search_bar_text: Color::new(0.880, 0.900, 0.875, 1.0),
    selection: Color::new(0.520, 0.640, 0.545, 0.34),
    cursor_accent: Color::new(0.860, 0.915, 0.855, 1.0),
    badge_bg: Color::new(0.520, 0.640, 0.545, 0.145),
    badge_bg_unfocused: Color::new(0.520, 0.640, 0.545, 0.090),
    badge_text: Color::new(0.715, 0.765, 0.700, 1.0),
    badge_text_dimmed: Color::new(0.400, 0.430, 0.405, 1.0),
    badge_git_branch: Color::new(0.690, 0.790, 0.675, 1.0),
    badge_git_worktree: Color::new(0.440, 0.720, 0.650, 1.0),
    popup_bg: Color::new(0.058, 0.066, 0.061, 1.0),
    popup_border: Color::new(0.150, 0.174, 0.157, 1.0),
    popup_selected: Color::new(0.520, 0.640, 0.545, 0.090),
    link_color: Color::new(0.500, 0.700, 0.620, 1.0),
    current_line_bg: Color::new(0.520, 0.640, 0.545, 0.045),
    indent_guide: Color::new(0.520, 0.640, 0.545, 0.080),
    active_indent_guide: Color::new(0.520, 0.640, 0.545, 0.155),
    bracket_match_bg: Color::new(0.520, 0.640, 0.545, 0.105),
    bracket_match_border: Color::new(0.520, 0.640, 0.545, 0.300),
    scrollbar_thumb_hover: Color::new(0.520, 0.640, 0.545, 0.280),
    ws_sidebar_text_inactive: Color::new(0.610, 0.650, 0.615, 1.0),
    ..DARK
};

pub static SAGE_LIGHT: ThemePalette = ThemePalette {
    surface_bg: Color::rgb(0.944, 0.951, 0.944),
    pane_bg: Color::rgb(0.982, 0.985, 0.978),
    file_tree_bg: Color::rgb(0.936, 0.944, 0.936),
    border_color: Color::rgb(0.770, 0.795, 0.770),
    border_focused: Color::new(0.420, 0.555, 0.450, 0.44),
    border_subtle: Color::rgb(0.770, 0.795, 0.770),
    tree_text: Color::rgb(0.180, 0.210, 0.185),
    tree_dir: Color::rgb(0.140, 0.170, 0.145),
    tree_dir_icon: Color::rgb(0.360, 0.540, 0.390),
    tree_icon: Color::rgb(0.430, 0.470, 0.435),
    tree_row_active: Color::new(0.420, 0.555, 0.450, 0.085),
    file_tree_focus_fill: Color::new(0.420, 0.555, 0.450, 0.120),
    file_tree_focus_stroke: Color::new(0.420, 0.555, 0.450, 0.280),
    tab_bar_bg: Color::rgb(0.936, 0.944, 0.936),
    tab_bar_bg_focused: Color::rgb(0.956, 0.961, 0.954),
    active_tab_bg: Color::rgb(0.982, 0.985, 0.978),
    tab_text: Color::rgb(0.425, 0.460, 0.430),
    tab_text_active: Color::rgb(0.250, 0.290, 0.255),
    tab_text_focused: Color::rgb(0.135, 0.165, 0.140),
    close_icon: Color::rgb(0.425, 0.460, 0.430),
    dock_tab_underline: Color::rgb(0.420, 0.555, 0.450),
    gutter_text: Color::rgb(0.420, 0.555, 0.450),
    gutter_active_text: Color::rgb(0.135, 0.165, 0.140),
    editor_modified: Color::rgb(0.610, 0.500, 0.280),
    drop_fill: Color::new(0.420, 0.555, 0.450, 0.095),
    drop_border: Color::new(0.420, 0.555, 0.450, 0.280),
    swap_border: Color::new(0.420, 0.555, 0.450, 0.380),
    scrollbar_match: Color::new(0.610, 0.500, 0.280, 0.42),
    scrollbar_current: Color::rgb(0.420, 0.555, 0.450),
    hover_tab: Color::rgb(0.895, 0.908, 0.895),
    search_match_bg: Color::new(0.610, 0.500, 0.280, 0.48),
    search_current_bg: Color::new(0.610, 0.500, 0.280, 0.74),
    search_bar_bg: Color::rgb(0.982, 0.985, 0.978),
    search_bar_border: Color::rgb(0.770, 0.795, 0.770),
    search_bar_text: Color::rgb(0.135, 0.165, 0.140),
    selection: Color::new(0.420, 0.555, 0.450, 0.25),
    cursor_accent: Color::rgb(0.135, 0.165, 0.140),
    badge_bg: Color::new(0.420, 0.555, 0.450, 0.095),
    badge_bg_unfocused: Color::new(0.420, 0.555, 0.450, 0.060),
    badge_text: Color::rgb(0.170, 0.225, 0.175),
    badge_text_dimmed: Color::rgb(0.425, 0.460, 0.430),
    badge_git_branch: Color::rgb(0.420, 0.555, 0.450),
    badge_git_worktree: Color::rgb(0.300, 0.560, 0.500),
    popup_bg: Color::rgb(0.982, 0.985, 0.978),
    popup_border: Color::rgb(0.770, 0.795, 0.770),
    popup_selected: Color::new(0.420, 0.555, 0.450, 0.095),
    popup_scrim: Color::new(0.0, 0.0, 0.0, 0.14),
    link_color: Color::rgb(0.370, 0.585, 0.500),
    current_line_bg: Color::rgb(0.925, 0.935, 0.925),
    indent_guide: Color::rgb(0.760, 0.790, 0.760),
    active_indent_guide: Color::rgb(0.500, 0.545, 0.505),
    bracket_match_bg: Color::new(0.420, 0.555, 0.450, 0.18),
    bracket_match_border: Color::rgb(0.420, 0.555, 0.450),
    ws_sidebar_text_inactive: Color::rgb(0.425, 0.460, 0.430),
    ..LIGHT
};

pub fn palette_for(dark_mode: bool, palette: ThemePalettePreference) -> &'static ThemePalette {
    match (dark_mode, palette) {
        (true, ThemePalettePreference::Tide) => &DARK,
        (false, ThemePalettePreference::Tide) => &LIGHT,
        (true, ThemePalettePreference::Graphite) => &GRAPHITE_DARK,
        (false, ThemePalettePreference::Graphite) => &GRAPHITE_LIGHT,
        (true, ThemePalettePreference::Sage) => &SAGE_DARK,
        (false, ThemePalettePreference::Sage) => &SAGE_LIGHT,
    }
}
...
pub const HEADER_BAR_HEIGHT: f32 = 26.0;
...
pub const TITLEBAR_CONTROL_FONT_SIZE: f32 = 14.0;
