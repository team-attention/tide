...
pub(crate) struct WindowState {
    ...
    pub chrome_cell_size: crate::tide_core::Size,
    pub titlebar_cell_size: crate::tide_core::Size,
...
impl WindowState {
    pub fn new(top_inset: f32) -> Self {
        Self {
            ...
            chrome_cell_size: crate::tide_core::Size::new(8.0, 16.0),
            titlebar_cell_size: crate::tide_core::Size::new(8.0, 16.0),
