...
use super::vertex::{GlyphVertex, RectVertex};
...
impl WgpuRenderer {
    ...
    pub fn render_frame(&mut self, encoder: &mut wgpu::CommandEncoder, view: &wgpu::TextureView) {
        ...
        if self.grid_needs_upload {
            ...
            let bg_stride = std::mem::size_of::<super::vertex::GridBgInstance>();
            let glyph_stride = std::mem::size_of::<super::vertex::GridGlyphInstance>();
