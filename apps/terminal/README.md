...
<img src="../../assets/icon.png" alt="Tide Terminal" width="96" />
...
## How Tide Terminal Is Organized
...
These are the default macOS shortcuts. GlobalAction binding overrides are stored in the platform config directory: `~/Library/Application Support/tide-terminal/settings.json`. Open settings with `Cmd+,`.
...
| `Cmd+N` | New Tide Terminal Window |
| `Cmd+,` | Open settings |
