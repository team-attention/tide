...
/// Window/display state — scale, size, font, dark mode, fullscreen, modifiers.
...
/// GPU resources — device, queue, surface, renderer, render thread.
...
impl TimingState {
    pub fn new() -> Self {
        ...
        Self { last_frame: now, last_child_check: now, resize_deferred_at: None, badge_check_at: None, cursor_blink_at: now, cursor_visible: true, last_session_save: now, last_cwd: None }
    }
}
...
impl DockState {
    pub fn new() -> Self {
        Self { terminal_view_mode: ViewMode::Split, dock_open: false, dock_width: 400.0, dock_border_dragging: false, dock_split_dragging: false, pinned_dock_layout: tide_layout::SplitLayout::new(), pinned_dock_ratio: 0.5, pinned_border_dragging: false, dock_zoomed: false }
    }
    ...
    pub fn is_pane_pinned(&self, pane_id: tide_core::PaneId) -> bool {
...
pub(crate) struct PaneAssociations {
    pub associated_terminal: std::collections::HashMap<tide_core::PaneId, tide_core::PaneId>,
    pub retained_contexts: std::collections::HashMap<tide_core::PaneId, crate::pane::TerminalContext>,
    pub pending_terminal_close: Option<tide_core::PaneId>,
}

impl PaneAssociations {
    pub fn new() -> Self {
        Self { associated_terminal: std::collections::HashMap::new(), retained_contexts: std::collections::HashMap::new(), pending_terminal_close: None }
    }
}
