...
mod tests {
    ...
    fn two_panes_horizontal() -> Vec<(crate::tide_core::PaneId, Rect)> {
        vec![
    ...
    fn two_panes_vertical() -> Vec<(crate::tide_core::PaneId, Rect)> {
        vec![
    ...
    fn trait_route_keyboard_to_focused() {
        use crate::tide_core::InputRouter as _;
    ...
    fn empty_pane_rects() {
        let mut router = Router::new();
        let panes: Vec<(crate::tide_core::PaneId, Rect)> = vec![];
