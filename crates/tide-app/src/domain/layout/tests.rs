#[cfg(test)]
mod tests {
    use super::super::SplitLayout;
    use crate::tide_core::{LayoutEngine, PaneDecorations, Rect, Size, SplitDirection, Vec2};
    ...
    fn assert_no_gaps_no_overlaps(rects: &[(crate::tide_core::PaneId, Rect)], window: Size) {
    ...
    fn test_restructure_move_to_root_left() {
        ...
        assert!(layout.restructure_move_to_root(4, crate::tide_core::DropZone::Left, WINDOW));
    ...
    fn test_restructure_move_pane_to_pane2_left() {
        let mut layout = make_quadrant_layout();
        assert!(layout.restructure_move_pane(4, 2, crate::tide_core::DropZone::Left, WINDOW));
    ...
    fn test_restructure_move_pane4_to_pane1_left() {
        let mut layout = make_quadrant_layout();
        assert!(layout.restructure_move_pane(4, 1, crate::tide_core::DropZone::Left, WINDOW));
    ...
    fn test_restructure_move_pane4_to_pane1_right() {
        let mut layout = make_quadrant_layout();
        assert!(layout.restructure_move_pane(4, 1, crate::tide_core::DropZone::Right, WINDOW));
    ...
    fn test_restructure_move_to_root_top() {
        let mut layout = make_quadrant_layout();
        assert!(layout.restructure_move_to_root(4, crate::tide_core::DropZone::Top, WINDOW));
    ...
    fn test_restructure_move_to_root_bottom() {
        let mut layout = make_quadrant_layout();
        assert!(layout.restructure_move_to_root(4, crate::tide_core::DropZone::Bottom, WINDOW));
    ...
    fn test_restructure_move_pane4_to_pane3_top() {
        let mut layout = make_quadrant_layout();
        assert!(layout.restructure_move_pane(4, 3, crate::tide_core::DropZone::Top, WINDOW));
    ...
    fn test_restructure_swap_center() {
        ...
        assert!(layout.restructure_move_pane(4, 1, crate::tide_core::DropZone::Center, WINDOW));
    ...
    fn test_restructure_single_pane_noop() {
        let (mut layout, pane_a) = SplitLayout::with_initial_pane();
        assert!(!layout.restructure_move_to_root(pane_a, crate::tide_core::DropZone::Left, WINDOW));
    ...
    fn test_restructure_same_pane_noop() {
        let mut layout = make_quadrant_layout();
        assert!(!layout.restructure_move_pane(4, 4, crate::tide_core::DropZone::Left, WINDOW));
    ...
    fn test_simulate_drop_restructure_root() {
        ...
        let preview = layout.simulate_drop(4, None, crate::tide_core::DropZone::Left, true, WINDOW);
    ...
    // ──────────────────────────────────────────
    // Leaf operations (post-TabGroup removal)
    // ──────────────────────────────────────────
